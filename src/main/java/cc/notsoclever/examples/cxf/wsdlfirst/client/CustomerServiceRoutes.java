...
public class CustomerServiceRoutes extends RouteBuilder {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CustomerServiceRoutes.class);

    @Override
    public void configure() throws Exception {

        logger.info("Starting client routes");

        // Fire off all the tests.
        from("timer://NotFoundTest?repeatCount=0&delay=60s")
                .multicast()
                //.to("direct:getCustomersTest", "direct:noSuchCustomerTest", "direct:updateCustomerTest");
                .to("direct:updateCustomerTest");
        ...
        from("direct:getCustomersTest")
                ...
                .process(new Processor() {
                    ...
                    public void process(Exchange exchange) throws Exception {
                        ...
                        logger.info("SUCCESS: getCustomersByName");
                    }
                });
        ...
        from("direct:confirmUpdate")
                .process(new Processor() {
                    ...
                    public void process(Exchange exchange) throws Exception {
                        ...
                        logger.info("SUCCESS: updateCustomer");
                    }
                });
    }
}
